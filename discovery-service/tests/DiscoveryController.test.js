...
const DynamoServiceRegistry = require('../src/infrastructure/DynamoServiceRegistry');

jest.mock('../src/infrastructure/DynamoServiceRegistry'); // Mocka o DynamoServiceRegistry
...
describe('DiscoveryController', () => {
  ...
  describe('removeService', () => {
    ...
    test('deve remover o serviço e retornar 200 se todos os dados forem fornecidos', async () => {
      ...
      expect(DynamoServiceRegistry.prototype.removeService).toHaveBeenCalledWith('pagamentos', 3000);
      expect(res.status).toHaveBeenCalledWith(200);
    ...
    test('deve retornar erro 500 se o DynamoServiceRegistry falhar', async () => {
      const req = mockRequest({ name: 'pagamentos', port: 3000 });
      const res = mockResponse();
      DynamoServiceRegistry.prototype.removeService.mockImplementationOnce(() => {
